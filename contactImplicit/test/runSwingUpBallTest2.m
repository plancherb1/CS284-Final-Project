function runSwingUpBallTest2()
    ...
    plant = plant.addRobotFromURDF('../urdf/PlanarManipulatorStand.urdf',zeros(3,1),zeros(3,1),struct('floating',true));
    ...
    function [g,dg] = cost(dt,x,u)
        ...
        Q = -100;
        g = Q*x(size(x,1));
        dg = [zeros(1,size(x,1)),Q,zeros(1,size(u,1))];
    end
