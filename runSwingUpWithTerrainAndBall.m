function runSwingUp()
    ...
    options.view = 'right';
    %terrain_height = -2.2;
    %options.terrain = RigidBodyFlatTerrain(terrain_height);
    ...
    %{
    brick_state_0 = [3;0;0];
    brick_state_f = [3;terrain_height+0.15;0];
    brick_vel_0 = [0;0;0];
    brick_vel_f = [0;0;0];
    ...
    options.integration_method = 1; %Forward Euler = 1
    ...
    function [xtraj] = initTraj(x0,xf,tf0,N)
        %xtraj = PPTrajectory(foh([0,tf0],[double(x0),double(xf)]));
        %return;
        ...
        %{
        brick_state_m = [3;terrain_height+0.15;0];
        brick_vel_m = [0;0;0];
